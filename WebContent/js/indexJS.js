...
$(document).ready(function () {
    ...
    $("#signin").click(function () {
        ...
        $("#connection").addClass("signInSignUpFormVisible");
        $("#inscription").removeClass("signInSignUpFormVisible");
        
    });
    
    $("#signup").click(function () {
        
        $("#inscription").addClass("signInSignUpFormVisible");
        $("#connection").removeClass("signInSignUpFormVisible");
